...
describe("identifyModelVendor", () => {
  ...
  test("fails closed when catalogs are unreadable, collide, or claim nothing", () => {
    ...
    const collision: Partial<Record<"claude" | "codex" | "grok" | "kimi" | "opencode", ProviderDiscovery>> = {
      ...
      opencode: { status: "ok", records: [], effectiveDefault: { provider: "opencode", model: unknown<string>("field-absent", "opencode.models", AT), effort: unknown<string>("field-absent", "opencode.models", AT) } },
    };
