...
const validCases: readonly WireCorpusCase[] = [
  ...
  { name: "INPUT_ORPHAN_DISCARD exact generation", schema: "orphanDiscardPayload", value: { schemaVersion: 1, locator: fixtureLocator } },
  { name: "ORPHAN_DISCARDED names the prior owner", schema: "orphanDiscardedPayload", value: { schemaVersion: 1, discarded: true, priorOwnerViewerId: "viewer-a", priorClaimId: "clm_018f1e90-7b5a-7cc0-8000-000000000001", diagnostic: "orphaned human claim discarded" } },
...
const invalidCases: readonly WireCorpusCase[] = [
  ...
  { name: "ORPHAN_DISCARDED rejects a missing diagnostic", schema: "orphanDiscardedPayload", value: { schemaVersion: 1, discarded: false, priorOwnerViewerId: null, priorClaimId: null } },
