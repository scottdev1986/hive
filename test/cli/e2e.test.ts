...
import { runHiveEvent } from "../../src/cli/event";
import { fetchAgentStatus, sendOrchestratorMessage } from "../../src/cli/mcp";
  ...
  test("real event POSTs drive status observed through the real MCP client", async () => {
    ...
    const spawner = new HiveSpawner({
      ...
      readRoutingPolicy: () => ({
        ...
        models: [{ provider: "codex", model: "gpt-test", state: "enabled", effort: { mode: "exact", value: "medium" } }],
