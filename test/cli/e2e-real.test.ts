...
import { BunTmuxSender } from "../../src/daemon/delivery";
import { TmuxAdapter } from "../../src/adapters/tmux";
import { TmuxSessionHost } from "../../src/daemon/session-host/tmux-host";
import { hiveInstanceSuffix } from "../../src/daemon/tmux-sessions";

const enabled = process.env.HIVE_E2E === "1" && Bun.which("tmux") !== null;
if (!enabled) {
  console.warn(
    "Skipping the real-CLI e2e suite (test/cli/e2e-real.test.ts): " +
