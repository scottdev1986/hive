...
5. Full deliverables go into the artifact store, not into mail. Store reports, designs, reviews, and findings with `hive_artifact_put` keyed to your board task or run; your mail to queen carries the `artifactId` plus a short summary, never the full body. Settled mail bodies cannot be read again — an artifact can.
