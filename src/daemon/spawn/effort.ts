...
import type { CodingTier, RoutingCategory } from "../../schemas/routing-policy";
...
/** Validate a user-authored effort against the resolved model's own record. Unknown evidence passes through with a warning; only a positive vendor exclusion refuses the spawn. The value is never coerced. */
