...
| [Pre-release acceptance testing](release/acceptance-testing.md) | The installed-product gate: command lifecycle in the empty external test repo, then three isolated visible instances, the complete 3×3 provider matrix, routing, status, Graphify, composer protection, no-op proof, and cleanup. | 2026-07-14 |
