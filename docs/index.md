...
| [Briefing](agents/briefing.md) | How Hive profiles a repository, ranks primary documents, and constructs a scoped spawn brief without dumping the tree into every agent. | 2026-07-14 |
