...
These five branches were deleted after their work was found on main or deliberately superseded. Their tip commits remain recoverable: run `git branch <branch> <tip>` to restore any branch exactly as it was before disposal.
