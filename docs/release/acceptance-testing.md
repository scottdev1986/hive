...
- Launch only through `hive`. Queen vendor is chosen in the Workspace, not by a CLI spelling. Private helper commands are implementation details, and `--smoke` is not acceptance.
