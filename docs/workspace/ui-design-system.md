...
- **Off-ramp fonts in shipped chrome.** Nine sites set a point size directly instead of reading a token, so they did not move when the ramp was raised to its 11 pt floor and now render smaller than the tier they sit in: `ProjectSwitcher.swift:64`, `AppDelegate.swift:379`, `Settings/RouteEditorView.swift:65,165,205,395`, `Settings/AppearanceSettingsController.swift:61`, `Settings/EffortControlView.swift:19`, `Settings/ProviderCardView.swift:302`, `Settings/SettingsPageController.swift:130`. Five more hardcode an SF Symbol point size that no longer tracks the text beside it: `Settings/ModelRowView.swift:109`, `Settings/RouteEditorView.swift:438`, `Settings/ProviderCardView.swift:283,298`, `Shell/ShellSidebarView.swift:111`.
