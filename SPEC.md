...
- **Run state** — who's building what right now, task assignments, "agent-2 finished the API." Lives in the daemon's SQLite and dies with the hive session. Calling this "memory" was the conflation to kill.
