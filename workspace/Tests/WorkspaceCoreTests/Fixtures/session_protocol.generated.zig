...
pub const wire_schema = struct {
    ...
    pub const terminal_host_subscription_event = "terminalHostSubscriptionEvent";
    pub const terminal_host_event_acknowledgement_request = "terminalHostEventAcknowledgementRequest";
    pub const terminal_host_event_acknowledgement = "terminalHostEventAcknowledgement";
