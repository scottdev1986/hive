...
final class B20EngineContractTests: XCTestCase {
    func testProductionViewSuppressesRepliesAndPresentsOrderedNeutralReplay() throws {
        ...
        let writes = WriteTranscript(recording: view.engine.callbackContext)
        let chunks = [
        ...
        XCTAssertTrue(waitUntil { writes.chunks == [Data("input-positive-control".utf8)] },
