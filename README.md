...
| `hive init [--refresh]` | Install agent skills, seed optional memory, offer Graphify, start the daemon; still runs the outgoing deterministic profile pass (`--refresh` rebuilds it until plan package P5) |
